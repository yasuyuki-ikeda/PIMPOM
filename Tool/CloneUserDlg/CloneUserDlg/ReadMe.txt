================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CloneUserDlg プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CloneUserDlg には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CloneUserDlg アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
CloneUserDlg.h
   ...
   CCloneUserDlgApp アプリケーション クラスを宣言します。

CloneUserDlg.cpp
   これは、アプリケーション クラス CCloneUserDlgApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CloneUserDlg.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CloneUserDlg.rc に含まれていま
   す。

res\CloneUserDlg.rc2
...
CloneUserDlgDlg.h, CloneUserDlgDlg.cpp - ダイアログ
   これらのファイルは CCloneUserDlgDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CloneUserDlg.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CloneUserDlg.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
